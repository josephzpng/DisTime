...
def collate_fn(batches):
    ...
    return pixel_values, questions, query, video_id, num_patches_lists, duration, frame_times
...
def evaluate_chat_model():
    ...
    json_file = 'data_example/charades/test_float.json'
    video_root = 'data/Charades_v1_480' # Charades_v1_480 video path

    vid_dataset = CharadesDataset(
        json_file=json_file, 
    ...
    result = {}
    res_id = {}
    for _, (pixel_values, questions, query, video_id, num_patches_lists, duration, frame_times) in tqdm(enumerate(dataloader), total=len(dataloader)):
        ...
        if video_id[0] not in res_id:
            res_id[video_id[0]] = {}

        res_id[video_id[0]][query[0]] = res[query[0]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', type=str, default='charades')
    parser.add_argument('--batch-size', type=int, default=1)
    parser.add_argument('--num-workers', type=int, default=1)
    parser.add_argument('--num-beams', type=int, default=1)
    parser.add_argument('--temperature', type=float, default=0.0)
    parser.add_argument('--out-dir', type=str, default='results/Charades-STA/8B')
