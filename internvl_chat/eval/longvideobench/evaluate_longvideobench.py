...
data_dir = 'data/LongVideoBench/LongVideoBench'
...
def evaluate_chat_model():
    ...
    if dist.get_rank() == 0:
        ...
        results_file = Path(args.out_dir, f'{time_prefix}.json') 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--out-dir', type=str, default='results/LongVideoBench')
