...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        logger.info(f'use_pooling: {self.use_pooling}')
        logger.info(f'dec_reg: {self.dec_reg}')
        logger.info(f'enc_sigma: {self.enc_sigma}')
    ...
    def to_dict(self):
        ...
        output['use_pooling'] = self.use_pooling
        output['dec_reg'] = self.dec_reg
        output['enc_sigma'] = self.enc_sigma
        output['layer_num'] = self.layer_num
